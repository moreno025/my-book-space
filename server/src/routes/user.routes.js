...
router.post("/register", validateBody(registerSchema), register); //probado
router.post("/login", validateBody(loginSchema), login); //probado
router.post("/refresh-token", refreshToken); 
router.post("/logout", logout);
router.post("/forgot-password", validateBody(forgotPasswordSchema), forgotPassword); //probado
router.post("/update-password", validateBody(updatePasswordSchema), updatePassword); //probado
